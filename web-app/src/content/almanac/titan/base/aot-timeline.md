...
```mermaid
flowchart TB
    subgraph ANCIENT["Ancient History"]
        A1["~1,800 yrs ago — Ymir Fritz<br/>acquires Titan powers"]
        A2["~1,700 yrs ago — Ymir dies;<br/>Nine Titans split"]
    end

    subgraph EMPIRE["Eldian Empire Era"]
        E1["~990 yrs — Eldia crushes Marley<br/>and exterminates nations"]
        E2["~100 yrs ago — Karl Fritz<br/>145th King retreats to Paradis"]
    end

    ANCIENT --> EMPIRE

    EMPIRE --> GTW{"Great Titan War<br/>~Year 743"}

    GTW --> WALLS["Karl Fritz builds the Walls<br/>Eldians memory-wiped<br/>Marley rises as hegemon"]

    subgraph WALL_ERA["Within the Walls (Year 743–850)"]
        W1["Year 825 — Grisha Yeager born"]
        W2["Year 835 — Eren Yeager born"]
        W3["Year 845 — Wall Maria falls<br/>Colossal/Armored breach Shiganshina"]
        W4["Year 847 — 104th Training Corps formed"]
    end

    WALLS --> WALL_ERA

    subgraph YEAR850["Year 850 — The Turning Point"]
        T1["Spring — Battle of Trost<br/>Eren's Titan power revealed"]
        T2["1 month later — 57th Expedition<br/>Female Titan captured"]
        T3["2 months later — Uprising<br/>Historia crowned Queen"]
        T4["4 months later — Battle of Shiganshina<br/>Beast/Armored/Colossal defeated<br/>Erwin Smith dies<br/>Armin inherits Colossal"]
    end

    WALL_ERA --> YEAR850

    YEAR850 --> POST["Post-Shiganshina<br/>Grisha's basement revealed<br/>Truth of the world known"]

    POST --> GATE{"The Gate Opens<br/>Modern Saturday evening<br/>Yellow Sea"}

    GATE --> CH1["Chapter 01<br/>First Contact"]
```
