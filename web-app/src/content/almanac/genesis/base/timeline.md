...
| 1914-09-18 | International community learns of portal via satellite. [[United States|US]] demands joint military command; [[France]] asserts [[UNCLOS]] jurisdiction; [[Germany]] constrained by Grundgesetz. [[NATO]] session produces no resolution. | A cable arrives from the [[Principality of New Antioch|Office of the Propagation of Virtue]]: *Verify before you venerate.* The Faithful front fractures. A courier vessel departs south — the [[Iron Sultanate]] is watching. [[Chapter 05 – Gathering Storm]] |
